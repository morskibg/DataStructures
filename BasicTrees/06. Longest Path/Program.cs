...
namespace _06.Longest_Path
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Tree<int> logestLeftLeaf = nodesInLayers.Last().Value.Dequeue();
            Stack<int> longestPath = new Stack<int>();
            while (logestLeftLeaf != null)
            {
                longestPath.Push(logestLeftLeaf.Value);
                logestLeftLeaf = logestLeftLeaf.Parent;
            }
